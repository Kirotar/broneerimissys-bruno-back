...
import ee.rara.bruno.bruno.util.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/register", "/auth/login","/", "/home", "/rooms/**", "/booking/get-room-availability", "/h2-console/**", "/swagger-ui/**", "/v3/api-docs").permitAll()
